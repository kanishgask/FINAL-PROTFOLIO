    ...
    if (!document.querySelector('.cert-modal')) {
        ...
        modal.innerHTML = `
            <div class="cert-modal-content">
                ...
                <img src="" alt="" class="cert-modal-img" id="modal-img">
                <div class="cert-modal-info">
                    <h3 id="modal-title"></h3>
                    <p id="modal-description"></p>
                    <div class="cert-modal-details">
                        <span class="cert-modal-detail">
                            <i class="fa-regular fa-calendar"></i>
                            <span id="modal-date"></span>
                        </span>
                        <span class="cert-modal-detail">
                            <i class="fa-regular fa-building"></i>
                            <span id="modal-issuer"></span>
                        </span>
                    </div>
                    <span class="cert-modal-badge" id="modal-badge"></span>
                </div>
            </div>
        `;
...
function openCertificateModal(cert) {
    ...
    document.getElementById('modal-img').src = cert.image;
    ...
    document.getElementById('modal-badge').textContent = cert.badge;
...
function initViewAllButton() {
    ...
    if (viewAllBtn) {
        viewAllBtn.addEventListener('click', (e) => {
            ...
            const navHeight = document.querySelector('.navbar').offsetHeight;
            const targetPosition = certSection.offsetTop - navHeight;
...
function downloadCertificate(cert) {
    // Create a dummy download link (replace with actual certificate PDF)
...
function shareCertificate(cert) {
    if (navigator.share) {
        ...
        // Fallback
        navigator.clipboard.writeText(cert.link).then(() => {
